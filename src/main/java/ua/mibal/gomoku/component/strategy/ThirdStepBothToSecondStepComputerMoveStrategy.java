 ...
 * @link t.me/mibal_ua
 */
public class ThirdStepBothToSecondStepComputerMoveStrategy extends AbstractComputerMoveStrategy implements ComputerMoveStrategy {

    public ThirdStepBothToSecondStepComputerMoveStrategy() {
        super(2);
    }
