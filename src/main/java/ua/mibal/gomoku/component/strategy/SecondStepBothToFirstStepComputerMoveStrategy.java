 ...
 * @link t.me/mibal_ua
 */
public class SecondStepBothToFirstStepComputerMoveStrategy extends AbstractComputerMoveStrategy implements ComputerMoveStrategy {

    public SecondStepBothToFirstStepComputerMoveStrategy() {
        super(1);
    }
